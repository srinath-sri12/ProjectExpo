...
<%
	...
	<a class="sample"><button class="btn btn-success" type="submit" name="login" value="login">LOGIN</button></a>
 	<button class="btn btn-success" type="submit" name="login" value="signup">SIGNUP</button>	
<%
}
else{
%>
	...
	<div id="logreg-forms">
		<div class="card text-center">
			...
			<div class="card-body">
				...
				<p class="card-text">Add/Delete/Update a Student's Project.</p>
				<a href="add.jsp" class="btn btn-primary">Select</a>
			</div>
		</div>
		<br>
		<br>
		<div class="card text-center">
			...
			<div class="card-body">
				...
				<p class="card-text">Add/Delete/Update a Student's Paper Presentation.</p>
				<a href="update.jsp" class="btn btn-primary">Select</a>
			</div>
		</div>
		<br>
		<br>
		<div class="card text-center">
			<div class="card-header">EXTRA CURRICULAR </div>
			<div class="card-body">
				<h5 class="card-title">EXTRA CURRICULAR ACITIVIES</h5>
				<p class="card-text">Add/Delete/Update a Student's Extra-curricular activities.</p>
				<a href="delete.jsp" class="btn btn-primary">Select</a>
			</div>
		</div>
		<br>
		<br>
		<div class="card text-center">
			...
			<div class="card-body">
				<h5 class="card-title">Display Student's Data</h5>
				<p class="card-text">Display student's informations.</p>
