 	...
 	<button class="btn btn-success my-2 my-sm-0" type="submit" name="login" value="signup">SIGNUP</button> -->
      ...
      <div id="logreg-forms">
		<div class="card text-center">
			...
			<div class="card-body">
				<h5 class="card-title">Add new Extra-Curricular activity</h5>

				<a href="addextra.jsp" class="btn btn-primary">ADD</a>
			</div>
		</div>
		<br> <br>
		<div class="card text-center">
			<div class="card-header">Extra-Curricular</div>
			<div class="card-body">
				<h5 class="card-title">Update the Extra-Curricular activity</h5>

				<a href="searchextra.jsp" class="btn btn-primary">UPDATE</a>
			</div>
		</div>
		<br> <br>
		<div class="card text-center">
			<div class="card-header">Extra-Curricular</div>
			<div class="card-body">
				<h5 class="card-title">Delete a Extra-Curricular activity</h5>


				<a href="searchdeleteextra.jsp" class="btn btn-primary">DELETE</a>
			</div>
		</div>
