        ...
        rs=st.executeQuery();
        	...
        	while(rs.next()){
        		 String name =rs.getString("Student_Name");
            	        ...
            	        String papername=rs.getString("Activity_Name");
...
%>
   ...
   <div class="container">
            ...
            <form class="form-horizontal" role="form" action="UpdateExtra" method="post">
            
            
            <!-- below textfield for updating query like updat where "papername" -->
            
			<div class="form-group1">
                    <label for="updatepaer" style="color: #3002fc "; class="col-sm-6  control-label">Enter the Activity Name</label>
                    <div class="col-sm-6">
