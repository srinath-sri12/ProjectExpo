...
<div class="container">
            <form class="form-horizontal" role="form" action="Newpaper" method="post">
				...
				<div class="form-group">
                    <label for="paper" class="col-sm-3 control-label">PROJECT Name</label>
                    <div class="col-sm-12">
                        <input type="text" id="paper" name="ppaper"  placeholder="PROJECT Name" class="form-control" required autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
                        <input type="text" id="place" name="pplace" placeholder="Project presented place" class="form-control" required autofocus>
                    </div>
                </div>
				...
				<div>
					 <input type = "hidden" name="paper" value="project"> 
				</div>
				<br>
