...
<div class="container">
            <form class="form-horizontal" role="form" action="Newpaper" method="post">
				...
				<div class="form-group">
                    <label for="paper" class="col-sm-3 control-label">Activity Name</label>
                    <div class="col-sm-12">
                        <input type="text" id="paper" name="ppaper"  placeholder="Activity Name" class="form-control" required autofocus>
                    </div>
                </div>
				...
				<div class="form-group">
                    <label for="place" class="col-sm-3 control-label">Held Place</label>
                    <div class="col-sm-12">
                        <input type="text" id="place" name="pplace" placeholder="Presented place" class="form-control" required autofocus>
                    </div>
                </div>
				...
				<div>
					 <input type = "hidden" name="paper" value="extra"> 
				</div>
				<br>
